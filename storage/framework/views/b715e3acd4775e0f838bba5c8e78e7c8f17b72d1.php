...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
        ...
        <!-- Form -->
        <form method="get" action="<?php echo $__env->yieldContent('searchRoute'); ?>" class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
            <div class="form-group mb-0">
                <div class="input-group input-group-alternative">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                    </div>
                    <input class="form-control"  name="searchtxt" placeholder="Search" type="text" value="<?php echo e(Request()->searchtxt); ?>">
                </div>
            </div>
        </form>
        <!-- User -->
...
<?php /**PATH C:\Users\andre\car_project\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>